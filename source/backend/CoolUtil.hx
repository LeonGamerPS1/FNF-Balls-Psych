...
class CoolUtil
{
	...
	**/
	...
	public static function sparrowAtlas(spr:FlxSprite, sparrowNames:Array<String>)
	{
		if (sparrowNames == null)
			throw new ArgumentException('sparrowNames', 'sparrowNames cannot be null.');
		spr.frames = Paths.getMultiAtlas(sparrowNames);
		return spr;
	}
}
